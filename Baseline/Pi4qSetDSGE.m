% Pi4qSetDSGE
%
% This file estimates spec Four-Quarter Inflation T.
%   
...
StateEq = [...
    ...
    pi_tL-piL1_t;
    piL1_tL-piL2_t;
    rho*ir_tL+(1-rho)*(phipi*(pi_t+piL1_t+piL2_t+piL2_tL)/4+phix/4*xe_t)+sigmai/400*ei_t-ir_t;
    % Shocks
