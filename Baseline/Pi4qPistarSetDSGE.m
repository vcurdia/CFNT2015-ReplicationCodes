% Pi4qPistarSetDSGE
%
% This file estimates spec Four-Quarter Inflation with TVIT T.
%   
...
StateEq = [...
    ...
    pi_tL-piL1_t;
    piL1_tL-piL2_t;
    rho*ir_tL+(1-rho)*(pistar_t+phipi*((pi_t+piL1_t+piL2_t+piL2_tL)/4-pistar_t)+phix/4*xe_t)+sigmai/400*ei_t - ir_t;
    % Shocks
