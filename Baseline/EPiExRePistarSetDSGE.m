% EPiExRePistarSetDSGE
%
% This file estimates spec Forward-looking with TVIT W&T.
%   
...
StateEq = [...
    ...
    % Policy Rule
    rho*irL_t+(1-rho)*(re_t+pistar_t+phipi*(pi_tF-pistar_tF)+phix/4*xe_tF)+sigmai/400*ei_t - ir_t;
    % Shocks
