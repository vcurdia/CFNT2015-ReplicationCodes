% Pi4qGrowthPistarSetDSGE
%
% This file estimates spec Four-Quarter Inflation with TVIT T with Growth.
%   
...
%% Settings
FileName.Output = 'Pi4qGrowthPistar';
...
StateEq = [...
    ...
    rho*ir_tL+(1-rho)*(pistar_t+...
                       ...
                       phidy*(YA_t-YA_tL+gamma_t))+sigmai/400*ei_t - ir_t;
    % Shocks
