% HPEstLambdaPistarSetDSGE
%
% This file estimates spec TVIT T with HP Gap, estimated lambda.
%   
...
%% Settings
FileName.Output = 'HPEstLambdaPistar';
...
StateEq = [...
    ...
    % HP
    lambdaHP*(3*h_t-hL_t-3*h_tF+hF_tF)-xHP_t;
    YA_t-YA_tL+gamma_t-xHP_t+xHP_tL-h_t;
    h_tL-hL_t;
    h_tF-hF_t;
    % Policy Rule
    rho*ir_tL+(1-rho)*(pistar_t+phipi*(pi_t-pistar_t)+phix/4*xHP_t)+sigmai/400*ei_t - ir_t;
    % Shocks
