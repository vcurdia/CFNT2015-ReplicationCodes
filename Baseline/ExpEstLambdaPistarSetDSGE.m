% ExpEstLambdaPistarSetDSGE
%
% This file estimates spec TVIT T with Exp Gap, estimated lambda.
%   
...
%% Settings
FileName.Output = 'ExpEstLambdaPistar';
...
StateEq = [...
    ...
    % Exponential smoother gap
    lambdaExp/(1+lambdaExp)*(YA_t-YA_tL+gamma_t+xExp_tL)-xExp_t;
    % Policy Rule
    rho*ir_tL+(1-rho)*(pistar_t+phipi*(pi_t-pistar_t)+phix/4*xExp_t)+sigmai/400*ei_t - ir_t;
    % Shocks
