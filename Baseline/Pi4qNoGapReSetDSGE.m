% Pi4qNoGapReSetDSGE
%
% This file estimates spec Four-Quarter Inflation W.
%   
...
StateEq = [...
    ...
    pi_tL-piL1_t;
    piL1_tL-piL2_t;
    rho*ir_tL+(1-rho)*(re_t+phipi*(pi_t+piL1_t+piL2_t+piL2_tL)/4)+sigmai/400*ei_t - ir_t;
    % Shocks
