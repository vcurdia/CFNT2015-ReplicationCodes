% EPiExPistarSetDSGE
%
% This file estimates spec Forward-looking with TVIT T with Growth.
%   
...
%% Settings
FileName.Output = 'EPiEGrowthPistar';
...
StateEq = [...
    ...
    % Policy Rule
    rho*irL_t+(1-rho)*(pistar_t+phipi*(pi_tF-pistar_tF)+...
                       phidy*(YA_tF-YA_t+gamma_tF))+sigmai/400*ei_t - ir_t;
    % Shocks
