% Growth4qPistarSetDSGE
%
% This file estimates spec TVIT T with 4Q Growth.
%   
...
%% Settings
FileName.Output = 'Growth4qPistar';
...
StateEq = [...
    ...
    % Policy Rule
    YA_t-YA_tL+gamma_t-dYA_t;  %Growth rate
    dYA_tL-dYAL1_t;
    dYAL1_tL-dYAL2_t;
    (dYA_t+dYAL1_t+dYAL2_t+dYAL2_tL)/4-dYA4q_t;
    rho*ir_tL+(1-rho)*(pistar_t+phipi*(pi_t-pistar_t)+phidy*dYA4q_t)+sigmai/400*ei_t - ir_t;
    % Shocks
