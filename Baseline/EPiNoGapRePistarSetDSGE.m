% EPiNoGapRePistarSetDSGE
%
% This file estimates spec Forward-looking with TVIT W.
%   
...
%% Settings
FileName.Output = 'EPiNoGapRePistar';
...
StateEq = [...
    ...
    % Policy Rule
    rho*irL_t+(1-rho)*(re_t+pistar_t+phipi*(pi_tF-pistar_tF))+sigmai/400*ei_t - ir_t;
    % Shocks
