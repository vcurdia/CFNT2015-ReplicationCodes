% EPiExHPPistarSetDSGE
%
% This file estimates spec Forward-looking with TVIT T with HP Gap.
%   
...
StateEq = [...
    ...
    h_tF-hF_t;
    % Policy Rule
    rho*irL_t+(1-rho)*(pistar_t+phipi*(pi_tF-pistar_tF)+phix/4*xHP_tF)+sigmai/400*ei_t - ir_t;
    % Shocks
