% EPiEGrowthSetDSGE
%
% This file estimates spec Forward-Looking T with Growth.
%   
...
StateEq = [...
    ...
    % Policy Rule
    rho*irL_t+(1-rho)*(phipi*pi_tF+phidy*(YA_tF-YA_t+gamma_tF))+sigmai/400*ei_t - ir_t;
    % Shocks
