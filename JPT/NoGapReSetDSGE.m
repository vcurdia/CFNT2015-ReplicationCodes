% NoGapReSetDSGE
%
% This file estimates spec JPT W.
%   
...
StateVar = {...
    ...
    % Exogenous variables
    'z';'g';'mu';'lambdapstar';'lambdawstar';'bstar';'etamp'
...
%% Shocks
ShockVar = {'emp';'ez';'eg';'emu';'ep';'ew';'eb'};
...
StateEq = [...
    ...
    JPTrhoR*R_tL+(1-JPTrhoR)*(rn_t+JPTphipi*pi_t)+etamp_t-R_t;
...
%% Use Starting Vector
guess=[0.2 0.21	0.15 0.53 0.85 0.25 0.12 0.5 0.75 0.1 4 0.85 0.75 5 2.5 2 0.1 0.25 0.8 0.25	0.98 0.7 0.95 0.98 0.7 0.15 0.75 0.95 0.2 0.9 0.35 5 0.15 0.2 0.05];
