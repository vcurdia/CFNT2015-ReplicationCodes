% RePistarSetDSGE
%
% This file estimates spec JPT with TVIT W&T.
%   
...
StateEq = [...
    ...
    JPTrhoR*R_tL+(1-JPTrhoR)*(rn_t+pistar_t+JPTphipi*(pi_t-pistar_t)+JPTphiY/4*gapn_t)+etamp_t-R_t;
